...
def create_app(settings_override=None):
    ...
    app.register_blueprint(admin, subdomain='<subdomain>')
    app.register_blueprint(page, subdomain='<subdomain>')
    app.register_blueprint(contact, subdomain='<subdomain>')
    app.register_blueprint(user, subdomain='<subdomain>')
    app.register_blueprint(api, subdomain='<subdomain>')
    app.register_blueprint(billing, subdomain='<subdomain>')
    app.register_blueprint(errors, subdomain='<subdomain>')
